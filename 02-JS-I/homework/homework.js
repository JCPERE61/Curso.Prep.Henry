...
function elevar(num, exponent) {
  ...
  // Tu código:
  var resu = Math.pow(num,exponent);
  return resu
}
elevar(3,2)
function redondearNumero(num) {
  ...
  // Tu código:
  var resu = Math.round(num);
  return resu
}
redondearNumero(1.34)
function redondearHaciaArriba(num) {
  // Redondea "num" hacia arriba (al próximo entero) y devuélvelo
  // Tu código:
  var resu = Math.ceil(num);
  return resu
}
redondearHaciaArriba(4.25)
